  ...
  <head>
    ...
    <style>
      .gradient {
        background: linear-gradient(90deg, #080808 0%, #800000 100%);
      }
    </style>
  </head>
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <!--Footer-->
    <footer class="py-12 px-4 md:py-16 bg-white sm:px-6 lg:px-8">
      <div class="grid gap-8 mx-auto lg:max-w-screen-xl sm:max-w-3xl md:grid-cols-3 md:gap-y-12 lg:grid-cols-4">
        ...
        <div class="flex flex-col lg:mx-auto">
          <div class="flex items-center">
            <a href="/" class="text-2xl font-black lg:block group">
              <span class="text-black transition duration-200 ease-in-out group-hover:text-gray-300">Web</span>
              <span class="transition duration-200 ease-in-out text-black  group-hover:text-black ">site</span>
            </a>
          </div>
          <div class="mt-6 text-lg md:mt-8 text-black ">
            © 2021 
        ...
        <div class="lg:mx-auto">
          ...
          <ul class="mt-2 space-y-1 text-lg">
            <li class="font-medium text-black  hover:text-red-500">
              <a href="/">
                Home
              </a>
            </li>
        ...
        <div class="sm:col-span-3 lg:col-span-1 lg:mx-auto">
          ...
          <div class="mt-4 w-full lg:mt-6">
            ...
            <div class="flex justify-start space-x-4">
              ...
              <!-- Instagram -->
              <a class="flex justify-center items-center w-12 h-12 rounded-full transition duration-300 ease-in-out bg-red-700 hover:text-gray-900 hover:bg-red-500  text-black" href="/">
